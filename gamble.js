...
function gambleCheck() {
    if(save.gamblingUnlocked) {
        doge('gambleButton').style.display = 'unset'
    } else {
        doge('gambleButton').style.display = 'none'
    }
}
...
function startGamble() {
    ...
    doge('gambleStartButton').style.boxShadow = 'inset -2px -2px rgb(60, 60, 60), inset 2px 2px rgb(40, 40, 40)'
    ...
    setTimeout(() => {
        ...
        if(amountBet * outputs[randomValue] < amountBet) {
            ...
            doge('betWin').innerText = `+${formatNumber(amountBet * outputs[randomValue] - amountBet)}`
            console.log(amountBet * outputs[randomValue] - amountBet)
        ...
        console.log(outputs[randomValue])
        DeBread.shake('gamble', 10, 5, 5, 100)
        doge('gambleStartButton').style.boxShadow = 'inset 2px 2px rgb(60, 60, 60), inset -2px -2px rgb(40, 40, 40)'
