...
function unlockDevTools() {
    doge('devButton').style.display = 'unset'
...
const users = {
        ...
        messages: {
            ...
            self: [
                ...
                [
                    ...
                    'Well, first of all,                    the code was horrible.',
                    ...
                    'Also, It was really broken.',
                    'I played it recently and I found so many bugs that could of been prevented if I was better at programming.',
                ],
                [
    ...
    alex: {
        messages: {
            everyone: [
                ['kys'],
                ['@DEBREAD Ayden Caleb O\'Brien, 3717 Charles Ave. 64902']
            ],
            self: [
                ['stfu im programming'],
                ...
                [
                    'Time for some Kool Kotlin Facts',
                    'Kool Kotlin Fact™ #1:',
                    '- Kotlin can compile to JavaScript',
                ]
            ]
        },
        color: '#DE3629'
